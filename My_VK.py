...
class VkUser:
    ...
    def get_photo_list(self, photo_info):
        ...
        #     photo_dict = {'likes': photo['likes']['count'], 'size': photo['sizes'][-1]['type'],
        #                   'url': photo['sizes'][-1]['url'], 'data': datetime.fromtimestamp(photo['date']).strftime('%Y-%m-%d')}
...
if __name__ == '__main__':
    ...
    # pprint(vk.get_photo_list(photos_info))
    yd = YandexUser()
